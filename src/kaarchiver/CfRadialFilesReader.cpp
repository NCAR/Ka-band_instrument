...
bool
CfRadialFilesReader::getNextRay(RadxRay & ray) {
    return false;
//    // Make sure we have an open file and we're not at EOF
//    if ((! _radxFile.isOpen() || _radxFile.atEnd()) && ! _openNextFile())
//            return false;
//    // Where are we in the file?
//    qint64 pos = _radxFile.pos();
//    
//    int nread;
//    
...
//    while (true) {
//        if ((nread = _radxFile.peek((char*)&idAndLen, 8)) != 8) {
...
//    if ((nread = _radxFile.read(packetBuf, len)) != len) {
